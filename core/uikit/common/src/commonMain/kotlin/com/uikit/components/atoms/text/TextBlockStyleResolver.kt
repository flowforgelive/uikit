...
object TextBlockStyleResolver {
    ...
    fun resolve(config: TextBlockConfig, tokens: DesignTokens): ResolvedTextBlockStyle {
        return when (config.variant) {
            TextBlockVariant.H1 -> ResolvedTextBlockStyle(
